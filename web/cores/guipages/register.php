...
function run(array $param,string& $html,string& $body):void {
    ...
    InsertSingleTag("input",array("id"=>"email","type"=>"text","placeholder"=>"Input email here...")));
    $data.=InsertTags("div",array("class"=>"flex","style"=>InsertInlineCssStyle(array(
        "padding-top"=>"10px"
    ))), InsertTags("p",null,"Account Name:&nbsp;").
    InsertSingleTag("input",array("id"=>"name","type"=>"text","placeholder"=>"Input name here...")));
    $data.=InsertTags("div",array("class"=>"flex","style"=>InsertInlineCssStyle(array(
        "padding-top"=>"10px"
    ...
    InsertSingleTag("input",array("id"=>"passwd2","type"=>"password","placeholder"=>"Input password here...")));
    $data.=InsertTags("div",array("class"=>"flex","style"=>InsertInlineCssStyle(array(
